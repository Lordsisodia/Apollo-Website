...
export default function LeaderboardPage() {
  ...
  return (
    <div className="leaderboard-page min-h-screen bg-apollo-dark text-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="leaderboard-page__container max-w-7xl mx-auto">
        {/* Header */}
        <div className="leaderboard-page__header mb-8 sm:mb-12">
          {/* Back Button */}
          <Link
            to="/"
            className="leaderboard-page__back-button inline-flex items-center gap-2 text-apollo-blue hover:text-white transition-colors mb-4 sm:mb-6 text-sm sm:text-base"
          >
          ...
          <h1 className="leaderboard-page__title mt-6 text-3xl sm:text-section font-normal leading-tight">
            Revenue <span className="text-apollo-blue">Leaderboard</span>
          </h1>

          <p className="leaderboard-page__description mt-4 text-sm sm:text-lg text-apollo-text-secondary max-w-3xl">
        ...
        {/* Time Filter Section */}
        <div className="leaderboard-page__filter-section mb-6 sm:mb-10">
          <TimeFilter
        ...
        {/* Footer Note */}
        <div className="mt-8 sm:mt-12 text-center text-apollo-text-tertiary text-xs sm:text-sm px-2">
